...
SnapshotPolicy = Table(
    ...
    Column("trust_id", String(length=64), nullable=True),
...
QuotaOrder = Table(
    ...
    Column("quota", JSON, nullable=True),
    Column("cluster_id", String(length=36), nullable=True),
...
ManagedCluster = Table(
    ...
    Column("dashboard_url", String(length=255), nullable=True),
    Column("status", String(length=16), nullable=False),
