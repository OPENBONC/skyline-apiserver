...
# quota order status
QUOTA_ORDER_STATUS_PENDING = "pending"
QUOTA_ORDER_STATUS_WITHDRAWN = "withdrawn"
QUOTA_ORDER_STATUS_APPROVED = "approved"
QUOTA_ORDER_STATUS_REJECTED = "rejected"
QUOTA_ORDER_STATUSES = {
    QUOTA_ORDER_STATUS_PENDING,
    QUOTA_ORDER_STATUS_WITHDRAWN,
    QUOTA_ORDER_STATUS_APPROVED,
    QUOTA_ORDER_STATUS_REJECTED,
}

# resource order type
RESOURCE_ORDER_TYPE_QUOTA = "quota"
RESOURCE_ORDER_TYPE_CLUSTER = "cluster"
RESOURCE_ORDER_TYPES = {
    RESOURCE_ORDER_TYPE_QUOTA,
    RESOURCE_ORDER_TYPE_CLUSTER,
}

# managed cluster status
CLUSTER_STATUS_UNASSIGNED = "unassigned"
CLUSTER_STATUS_ASSIGNING = "assigning"
CLUSTER_STATUS_ASSIGNED = "assigned"
CLUSTER_STATUSES = {
    CLUSTER_STATUS_UNASSIGNED,
    CLUSTER_STATUS_ASSIGNING,
    CLUSTER_STATUS_ASSIGNED,
}

# allowed managed cluster status transitions
